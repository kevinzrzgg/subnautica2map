...
export const metadata: Metadata = { title: 'Repair Tool Subnautica 2: Location, Blueprint & Crafting Guide', description: 'Find Repair Tool fragments, scan route, crafting materials, and checklist.', alternates: { canonical: '/repair-tool/' } };

const faq = [
  ['Where is Repair Tool in Subnautica 2?', 'Repair Tool is tracked in the Early-game wreck areas section. Exact coordinates should be verified in-game because Early Access patches can move locations.'],
  ['What type of item is Repair Tool?', 'Repair Tool is listed as Blueprint in the Tools category.'],
...
export default function GuidePage() {
  return <>
    ...
    <main className="mx-auto max-w-5xl px-5 py-10">
      ...
      <div className="mt-6 card p-7 md:p-10"><span className="badge">Tools</span><h1 className="mt-4 text-4xl font-black md:text-6xl">Repair Tool Subnautica 2 Guide</h1><p className="mt-5 text-lg leading-8 text-cyan-50/75">Find Repair Tool fragments, scan route, crafting materials, and checklist.</p><div className="mt-6 grid gap-4 md:grid-cols-3"><div className="rounded-2xl bg-white/5 p-4"><b>Type</b><br/>Blueprint</div><div className="rounded-2xl bg-white/5 p-4"><b>Biome</b><br/>Early-game wreck areas</div><div className="rounded-2xl bg-white/5 p-4"><b>Depth</b><br/>~80-180m</div></div></div>
      <section className="mt-8 card p-7"><h2 className="text-3xl font-bold">Quick answer</h2><p className="mt-4 leading-8 text-cyan-50/75">Use this page as the fast lookup for <strong>subnautica 2 repair tool location</strong>. Check the map category, scan or collect the required item, then follow the related recipe and material links.</p></section>
